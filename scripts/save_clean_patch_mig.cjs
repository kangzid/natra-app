...
// 1. Update 2026_08_25_173000_patch_all_missing_hris_columns_for_tests.php with comprehensive, non-destructive test patches
const patchMig = path.join(backendDir, 'database/migrations/2026_08_25_173000_patch_all_missing_hris_columns_for_tests.php');
...
fs.writeFileSync(patchMig, content, 'utf8');
console.log('Saved clean non-destructive patch migration!');
