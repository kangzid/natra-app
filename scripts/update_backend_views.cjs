...
if (!routesContent.includes('/news/{id}/view')) {
    ...
    console.log('Updated routes/api.php with /news/{id}/view and /news/{id}!');
} else {
    console.log('routes/api.php already has news view routes.');
}

// 2. Update app/Models/HrisNews.php
...
console.log('Updated app/Models/HrisNews.php!');

// 3. Update app/Http/Controllers/Api/HrisNewsController.php
...
console.log('Updated app/Http/Controllers/Api/HrisNewsController.php with incrementView, show, and total_views!');
