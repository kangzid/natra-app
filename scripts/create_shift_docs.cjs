...
const docFilePath = path.join(docsDir, 'DOKUMENTASI_SISTEM_SHIFT_ROSTER_DAN_ROTASI.md');

const docContent = `# DOKUMENTASI SISTEM SHIFT KERJA, ROSTER KALENDER, & ROTASI OTOMATIS
...
console.log('Successfully written documentation to: ' + docFilePath);
