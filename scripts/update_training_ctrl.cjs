...
const controllerPath = path.join(backendDir, 'app/Http/Controllers/Api/HrisTrainingController.php');
...
console.log('Successfully updated HrisTrainingController.php!');
