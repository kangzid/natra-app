...
fs.writeFileSync(path.join(mobileDir, 'src/features/payroll/payroll.service.js'), serviceContent, 'utf8');
fs.writeFileSync(path.join(mobileDir, 'src/features/payroll/payroll.controller.js'), ctrlContent, 'utf8');

const wwwServ = path.join(mobileDir, 'www/src/features/payroll/payroll.service.js');
const wwwCtrl = path.join(mobileDir, 'www/src/features/payroll/payroll.controller.js');
if (fs.existsSync(wwwServ)) fs.writeFileSync(wwwServ, serviceContent, 'utf8');
if (fs.existsSync(wwwCtrl)) fs.writeFileSync(wwwCtrl, ctrlContent, 'utf8');

console.log('Successfully updated both mobile payroll.service.js and payroll.controller.js!');
