...
const ctrlPath = path.join(backendDir, 'app/Http/Controllers/Api/HrisComplianceController.php');
...
console.log('Successfully written complete and robust HrisComplianceController.php!');
