...
const claimControllerContent = `<?php
...
fs.writeFileSync('../backup/tracker-loc-backend/app/Http/Controllers/Api/HrisClaimController.php', claimControllerContent, 'utf8');
console.log('Successfully wrote HrisClaimController.php cleanly!');
