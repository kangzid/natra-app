...
const ctrlPath = path.join(backendDir, 'app/Http/Controllers/Api/HrisViolationController.php');

const newViolControllerContent = `<?php
...
fs.writeFileSync(ctrlPath, newViolControllerContent, 'utf8');
console.log('Successfully written complete HrisViolationController.php with default seeds, summary, and CRUD!');
