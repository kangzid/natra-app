...
const migrationPath = path.join(backendDir, 'database/migrations/2026_08_23_000001_create_hris_shifts_and_attendance_rules_table.php');
...
console.log('Fixed migration backslashes successfully at:', migrationPath);
